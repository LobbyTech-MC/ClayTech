...
public class DrinkMakingStaff {
    public DrinkMakingStaff() {
        SlimefunUtils.newResearch()
                ...
                .withName(Lang.readResearchesText("CLAYTECH_COCOA_BEAN_RESEARCH"))
                .withCost(10)
                .addItem(
        ...
        SlimefunUtils.newResearch()
                .withId(SlimefunUtils.getResearchId())
                .withName(Lang.readResearchesText("CLAYTECH_PLASTIC_RESEARCH"))
                .withCost(10)
                .addItem(
                        SlimefunUtils.newItem()
                                .withItemGroup(ClayTechItems.C_FOODMATERIALS)
        ...
        SlimefunUtils.newResearch()
                .withId(SlimefunUtils.getResearchId())
                .withName(Lang.readResearchesText("CLAYTECH_DRINK_BOTTLE_RESEARCH"))
                .withCost(10)
                .addItem(
                        SlimefunUtils.newItem()
                                .withItemGroup(ClayTechItems.C_FOODMATERIALS)
        ...
        SlimefunUtils.newResearch()
                .withId(SlimefunUtils.getResearchId())
                .withName(Lang.readResearchesText("CLAYTECH_DIRTY_DRINK_BOTTLE_RESEARCH"))
                .withCost(10)
                .addItem(
                        SlimefunUtils.newItem()
                                .withItemGroup(ClayTechItems.C_FOODMATERIALS)
        ...
        SlimefunUtils.newResearch()
                .withId(SlimefunUtils.getResearchId())
                .withName(Lang.readResearchesText("CLAYTECH_DIRTY_TEA_RESEARCH"))
                .withCost(10)
                .addItem(
                        SlimefunUtils.newItem()
                                .withItemGroup(ClayTechItems.C_FOODMATERIALS)
        ...
        SlimefunUtils.newResearch()
                .withId(SlimefunUtils.getResearchId())
                .withName(Lang.readResearchesText("CLAYTECH_RAW_TEA_RESEARCH"))
                .withCost(10)
                .addItem(
                        SlimefunUtils.newItem()
                                .withItemGroup(ClayTechItems.C_FOODMATERIALS)
        ...
        SlimefunUtils.newResearch()
                .withId(SlimefunUtils.getResearchId())
                .withName(Lang.readResearchesText("CLAYTECH_TEA_POWDER_RESEARCH"))
                .withCost(10)
                .addItem(
                        SlimefunUtils.newItem()
                                .withItemGroup(ClayTechItems.C_FOODMATERIALS)
        ...
        SlimefunUtils.newResearch()
                .withId(SlimefunUtils.getResearchId())
                .withName(Lang.readResearchesText("CLAYTECH_LEMON_POWDER_RESEARCH"))
                .withCost(10)
                .addItem(
                        SlimefunUtils.newItem()
                                .withItemGroup(ClayTechItems.C_FOODMATERIALS)
