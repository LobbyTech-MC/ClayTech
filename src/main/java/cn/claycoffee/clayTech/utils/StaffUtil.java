...
public class StaffUtil {
    ...
    public static @NotNull Set<Location> getRawLocations(@NotNull Block lookingBlock, @NotNull BlockFace lookingFacing, int limitBlocks, Function<Location, Boolean> filter) {
