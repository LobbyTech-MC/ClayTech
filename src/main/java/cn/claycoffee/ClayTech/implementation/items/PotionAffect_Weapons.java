...
public class PotionAffect_Weapons {
    public PotionAffect_Weapons() {
        SlimefunUtils.registerItem(ClayTechItems.C_MATERIALS, "BLIND_CORE", ClayTechItems.BLIND_CORE, "BlindnessCoreResearch", 10,
        ...
        SlimefunUtils.registerItem(ClayTechItems.C_MATERIALS, "ADVANCED_BLIND_CORE", ClayTechItems.ADVANCED_BLIND_CORE,
                "AdvancedBlindnessCoreResearch", 10, RecipeType.ANCIENT_ALTAR, ClayTechMachineRecipes.ADVANCED_BLIND_CORE, false);
        SlimefunUtils.registerItem(ClayTechItems.C_MATERIALS, "POISON_CORE", ClayTechItems.POISON_CORE, "PoisonCoreResearch",
        ...
        SlimefunUtils.registerItem(ClayTechItems.C_MATERIALS, "ADVANCED_POISON_CORE",
                ClayTechItems.ADVANCED_POISON_CORE, "AdvancedPoisonCoreResearch", 10, RecipeType.ANCIENT_ALTAR,
        ...
        SlimefunUtils.registerItem(ClayTechItems.C_MATERIALS, "CONFUSION_CORE", ClayTechItems.CONFUSION_CORE,
                "ConfusionCoreResearch", 10, ClayTechRecipeType.CLAY_CRAFTING_TABLE, ClayTechMachineRecipes.CONFUSION_CORE,
                false);
        SlimefunUtils.registerItem(ClayTechItems.C_MATERIALS, "ADVANCED_CONFUSION_CORE",
                ClayTechItems.ADVANCED_CONFUSION_CORE, "AdvancedConfusionCoreResearch", 10, RecipeType.ANCIENT_ALTAR,
        ...
        SlimefunUtils.registerItem(ClayTechItems.C_MATERIALS, "SLOWNESS_CORE", ClayTechItems.SLOWNESS_CORE,
                "SlownessCoreResearch", 10, ClayTechRecipeType.CLAY_CRAFTING_TABLE, ClayTechMachineRecipes.SLOWNESS_CORE, false);
        SlimefunUtils.registerItem(ClayTechItems.C_MATERIALS, "ADVANCED_SLOWNESS_CORE",
                ClayTechItems.ADVANCED_SLOWNESS_CORE, "AdvancedSlownessCoreResearch", 10, RecipeType.ANCIENT_ALTAR,
                ClayTechMachineRecipes.ADVANCED_SLOWNESS_CORE, false);

        SlimefunUtils.registerItem(ClayTechItems.C_MATERIALS, "POISON_EYE", ClayTechItems.POISON_EYE, "PoisonEyeResearch", 10,
        ...
        SlimefunUtils.registerItem(ClayTechItems.C_MATERIALS, "BLACK_ROCK_BLOCK", ClayTechItems.BLACK_ROCK_BLOCK,
                "BlackRockBlockResearch", 10, ClayTechRecipeType.CLAY_CRAFTING_TABLE, ClayTechMachineRecipes.BLACK_ROCK_BLOCK,
                false);

        SlimefunUtils.registerItem(ClayTechItems.C_WEAPONS, "BLIND_SWORD", ClayTechItems.BLIND_SWORD, "BlindSwordResearch", 10,
                ClayTechRecipeType.CLAY_CRAFTING_TABLE, ClayTechMachineRecipes.BLIND_SWORD, false);
        SlimefunUtils.registerItem(ClayTechItems.C_WEAPONS, "FOUR_BOW", ClayTechItems.FOUR_BOW, "FourBowResearch", 10,
                ClayTechRecipeType.CLAY_CRAFTING_TABLE, ClayTechMachineRecipes.FOUR_BOW, false);
        SlimefunUtils.registerItem(ClayTechItems.C_WEAPONS, "POISON_SWORD", ClayTechItems.POISON_SWORD, "PoisonSwordResearch",
                10, ClayTechRecipeType.CLAY_CRAFTING_TABLE, ClayTechMachineRecipes.POISON_SWORD, false);

        Research weapon_requires = new Research(new NamespacedKey(ClayTech.getInstance(), "CLAYTECH_EX_BASIC_WEAPONS"),                 9904, Lang.readResearchesText("CLAYTECH_BEFORE_AFFECT_WEAPONS"), 50);
        ...
        Research advancedweapon = new Research(new NamespacedKey(ClayTech.getInstance(), "CLAYTECH_ADVANCED_WEAPONS"),
                9907, Lang.readResearchesText("CLAYTECH_ADVANCED_AFFECT_WEAPONS"), 100);
